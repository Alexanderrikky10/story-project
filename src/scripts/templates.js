...
export function generateUnauthenticatedNavigationListTemplate() {
  return `
    <li><a id="new-report-button" class="btn new-report-button" href="#/add-story">Tambah Story <i class="fas fa-plus"></i></a></li>
...
export function generateAuthenticatedNavigationListTemplate() {
  return `
    ...
    <li><a id="new-report-button" class="btn new-report-button" href="#/new">Tambah Story <i class="fas fa-plus"></i></a></li>
...
export function generateReportDetailTemplate({
  ...
  const imagesHtml = evidenceImages.reduce(
    (accumulator, evidenceImage) =>
      accumulator.concat(generateReportDetailImageTemplate(evidenceImage, name)),
    '',
  );
    ...
    <div class="report-detail__header">
      ...
      <div class="report-detail__more-info">
        <div class="report-detail__more-info__inline">
          ...
          <div id="location-place-name" class="report-detail__location__place-name" data-value="${location}"><i class="fas fa-map"></i></div>
        </div>
        <div class="report-detail__more-info__inline">
    ...
    <div class="container">
      <div class="report-detail__body">
        <div class="report-detail__body__description__container">
          <h2 class="report-detail__description__title">Cerita Lengkap</h2>
